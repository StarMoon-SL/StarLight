...
local result = (function()
    ...
    local Colors = {
        ...
        surfaceLight = Color3.fromRGB(0, 0, 0),
        primary = Color3.fromRGB(100, 180, 255),
        primaryDark = Color3.fromRGB(80, 160, 235),
        primaryGlow = Color3.fromRGB(130, 200, 255),
        accent = Color3.fromRGB(100, 180, 255),
        success = Color3.fromRGB(100, 200, 255),
        successDark = Color3.fromRGB(80, 180, 235),
        successGlow = Color3.fromRGB(130, 220, 255),
        error = Color3.fromRGB(255, 100, 100),
        textPrimary = Color3.fromRGB(255, 255, 255),
        textSecondary = Color3.fromRGB(200, 220, 255),
        textMuted = Color3.fromRGB(150, 170, 200),
        border = Color3.fromRGB(100, 180, 255),
        borderLight = Color3.fromRGB(130, 200, 255),
    ...
    local function loadUIFactory()
        return function(Colors, Players, TweenService, UserInputService, Lighting)
            ...
            return function(self)
                ...
                self.gui.Name = "StarLightKeySystem"
                ...
                local glowTween = TweenService:Create(glowFrame,
                    ...
                    {BackgroundTransparency = 0.85, Size = UDim2.new(1, 80, 1, 80)}
                )
                glowTween:Play()
                ...
                brandLogoText.Text = "StarLight Key System"
                ...
                inputSection.BackgroundTransparency = 0.6
                ...
                getLinkButton.BackgroundTransparency = 0.2
                getLinkButton.Text = ""
                ...
                self.showSuccess = function(self, message)
                    ...
                    if loadingOverlay then
                        ...
                        if spinnerContainer then
                            ...
                            glowStroke.Color = Colors.success
    ...
    function UI.new(options)
        ...
        self.subtitle = self.options.subtitle or "Powered by StarLight"
